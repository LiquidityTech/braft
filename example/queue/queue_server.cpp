...
DEFINE_int32(max_size, 10000, "max size of the queue");
...
int main(int argc, char* argv[]) {
    ...
    google::SetLogDestination(google::GLOG_WARNING, (log_path+"warn").c_str());
    google::SetLogDestination(google::GLOG_ERROR, (log_path+"error").c_str());
