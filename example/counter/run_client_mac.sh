...
echo ${raft_peers}
echo "FLAGS_add_percentage: ${FLAGS_add_percentage}"
echo "FLAGS_bthread_concurrency: ${FLAGS_bthread_concurrency}"
echo "FLAGS_use_bthread: ${FLAGS_use_bthread}"
echo "FLAGS_thread_num: ${FLAGS_thread_num}"
echo "FLAGS_log_each_request: ${FLAGS_log_each_request}"
